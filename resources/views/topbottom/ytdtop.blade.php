        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Top YTD Nasabah</li>
                </ol>
            </div>
        </div>
...
onfocus='this.size=5;' onblur='this.size=1;' onchange='this.size=1; this.blur();' --}}
        <div class="card">
            <div class="card-title">
                <div class="container">
                    <form action="{{ route('funding-top-bottom-nasabah-ytd') }}" method="post">
                        @csrf
                        <br>
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <select name="year" id="year" class="form-control" required>
                                        ...
                                        @foreach (array_unique($tahun) as $year)
                                            <option value="top_ytd_{{ $year }}">{{ $year }}</option>
                                        @endforeach
                                    </select>
                                </div>
...
<script>
    $('#select-allz').click(function(event) {   
        if(this.checked) {
