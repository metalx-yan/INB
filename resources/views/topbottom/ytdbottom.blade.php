        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Bottom YTD Nasabah</li>
                </ol>
            </div>
        </div>
...
onfocus='this.size=5;' onblur='this.size=1;' onchange='this.size=1; this.blur();' --}}
        <div class="card">
            <div class="card-title">
                <div class="container">
                    <form action="{{ route('funding-bottom-nasabah-ytd') }}" method="post">
                        @csrf
                        <br>
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <select name="year" id="year" class="form-control" required>
                                        ...
                                        @foreach (array_unique($tahun) as $year)
                                            <option value="bottom_ytd_{{ $year }}">{{ $year }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                        ...
                                        <div class="col-md-3">
                                                <label for="">Jenis Tabungan</label>
                                                    <div class="dropdown">
                                                            ...
                                                            <br>
                                                            <div id="myDropdownj" class="dropdown-content" style="overflow-y: auto; top:40px; bottom:-250px;">
                                                            <input type="text" placeholder="Search.." id="myInputj" onkeyup="filterFunctioo()" >
                                        ...
                                        <div class="col-md-3">
                                                <label for="">Products</label>
                                                    <div class="dropdown">
                                                            ...
                                                            <input type="text" placeholder="Search.." id="myInputi" onkeyup="filterFunctioni()" >
                        ...
                        <tbody>
                            ...
                            @foreach ($sa as $val)
                                <tr>
                                    ...
                                    <td>{{ucfirst($val->flag_tabungan)}}</td>
...
// ============================================
        ...
        function filterFunction() {
          ...
          a = div.getElementsByClassName("cek");
                ...
                $('#year').on('change', function(e){
                    ...
                    var sub = year.substr(0,25);
                        ...
                        $.get('http://192.168.7.32:8080/bni/public/api/json-month-topbot?TABLE_NAME=' + year , function(data){
                            console.log(data);
                            var as = data.map(item => item.TABLE_NAME.slice(0,17))
                            ...
                            $.each(as, function(index, monthsObj) {
                                ...
                                $('#month').append('<option value="' + monthsObj + '" >' + monthsObj.substr(15,2) + '</option>');
                            });
                        });
                });
            });
                    ...
                    var sub = year.substr(0,25);
                        ...
                        $.get('http://192.168.7.32:8080/bni/public/api/json-day-topbot?TABLE_NAME=' + year , function(data){
                            ...
                            $.each(as, function(index, daysObj) {
                                console.log(daysObj);
                                $('#day').append('<option value="' + daysObj + '" >' + daysObj.substr(17,2) + '</option>');
                            });
                        });
                });
            });
