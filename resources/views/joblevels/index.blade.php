                ...
                <div class="modal fade" id="exampleModal" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Create Job Level</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body" >
                            <form action=" {{ route('joblevel.store') }} " method="post">
                                    @csrf
                                    <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <a href=" {{ route('joblevel.edit', $joblevel->id) }} " class="btn btn-warning btn-sm">Update
                                        ...
                                        <div class="col-xs-1">
                                            <form class="" action=" {{ route('joblevel.destroy', $joblevel->id) }} " method="POST">
                                                @csrf
                                                @method('DELETE')
