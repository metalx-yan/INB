                ...
                <table class="table border" id="myTable">
                    ...
                    <tbody>
                        @foreach ($sub as $subs)
                            <tr>
                                <td> {{ $subs->id }} </td>
                                <td> {{ $subs->permission->name }} </td>
                                <td> {{ $subs->name }} </td>
                                <td>
                                    <div class="row">
                                        <div class="col-xs-1">
                                       
                                        <a href=" {{ route('submenus.edit', $subs->id) }} " class="btn btn-warning btn-sm">Update
                                        ...
                                        <div class="col-xs-1">
                                            <form class="" action=" {{ route('submenus.destroy', $subs->id) }} " method="POST">
                                                @csrf
                                                @method('DELETE')
